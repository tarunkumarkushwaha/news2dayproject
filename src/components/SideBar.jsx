            ...
            <aside ref={menuRef} className={`fixed top-0 left-0 h-full transition-all duration-1000 ease-in-out ${!sidebar ? "md:w-[25vw] w-[60vw] -translate-x-full" : "md:w-[30vw] w-[60vw] -translate-x-1"}`}>
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-800">
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <div onClick={() => setnewstype("Headlines")} className="flex items-center p-2 cursor-pointer text-gray-100 rounded-lg hover:bg-gray-700">
                                <span className="flex-1 ms-3">Headlines</span>
                            </div>
                        </li>
                        <li>
                            <div onClick={() => setnewstype("Market stories")} className="flex items-center cursor-pointer p-2 text-gray-100 rounded-lg hover:bg-gray-700">
                                <span className="flex-1 ms-3">Market stories</span>
                            </div>
                        </li>
                        <li>
                            <div onClick={() => setnewstype("")} className="flex items-center cursor-pointer p-2 text-gray-100 rounded-lg hover:bg-gray-700">
                        ...
                        <li>
                            <div onClick={() => setnewstype("politics")} className="flex items-center cursor-pointer p-2 text-gray-100 rounded-lg hover:bg-gray-7 onClick={()=>setnewstype()}00">

                                <span className="flex-1 ms-3 ">politics</span>
                            </div>
                        </li>
                        <li>
                            <div onClick={() => setnewstype("Sports")} className="flex items-center cursor-pointer p-2 text-gray-100 rounded-lg hover:bg-gray-7 onClick={()=>setnewstype()}00">
