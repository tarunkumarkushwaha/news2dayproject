        ...
        <>
            <div className={`relative m-2 cursor-pointer bg-zinc-100 border-zinc-100 text-zinc-900
             ...
             w-[300px] border p-2 rounded-md flex flex-col`}>
                ...
                <p className={`absolute min-w-[270px] bottom-16 left-0 flex m-4 justify-center items-center h-[240px] overflow-hidden text-center rounded-lg bg-zinc-200 border-zinc-200 text-zinc-800`}>
                    {data.description}
                </p>
